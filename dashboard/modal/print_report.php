...
<div class="page">
    ...
    <div id="movable-container" style="position: absolute; top: 205px; left: 420px; display: flex; justify-content: left; align-items: left; height: 10px;">
    ...
    <table class="treatment-table" width="80%" border="0" cellspacing="0" cellpadding="4">
        <thead>
