...
function nett1xxx(str){
							  var o_dis=document.getElementById("grand1").value;
                            ...
                            <td width="19%" align="left"><input name="grand" type="text" class="text" id="grand"  readonly="readonly" value="<?php echo $final_amnt+$income_dis_amnt;?>"/></td>
							</tr>
							   <tr id="cashtr" >
							...
							<td width="85%" class="label1"><div align="right"> Round:</div></td>
                            <td width="19%" align="left"><input name="round" type="text" class="text" id="round"  readonly="readonly" value="<?php echo $round;?>"/></td>
							</tr>
                            ...
                            <td width="19%" align="left"><input name="grand1" type="text" class="text" id="grand1"  readonly="readonly" value="<?php echo $final_amnt;?>"/></td>
							</tr>
							<tr id="cashtr" style="display:''">
	...
	<input type="hidden" name="lrno" value="<?php echo $lr_id ?>" />
				...
				<?php }?>
				<input type="button" value="Close" onclick="window.location.href='salesentry_list.php'" class="butt"/></div></td>
                  </tr>
              </table></td>
            </tr>
          </table>
